<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="total-applications.aspx.cs" Inherits="MyAGC.admin.total_applications" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <td colspan="4">
         <asp:DropDownList ID="drpSearchBy" CssClass="form-control dropdown" AutoPostBack="false" runat="server">
                                            ...
                                            <asp:ListItem Value="4" Text="ProgramName"></asp:ListItem>
                                             <asp:ListItem Value="5" Text="ApplicationID"></asp:ListItem>
    ...
    <ItemTemplate>
        <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-danger" CommandName="DeleteItem" OnClientClick="return confirm('Are you sure want you want to delete this application?');" CommandArgument='<%#Eval("ID")%>'>
                       Delete
        </asp:LinkButton>
    </ItemTemplate>
</asp:TemplateField>
