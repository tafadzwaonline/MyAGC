...
{
    public partial class view_consultant : System.Web.UI.Page
    {
        ...
        private void getSavedUsers()
        {
            ...
            DataSet getsearchdata = um.GetSystemUserByUserRole(5);
        ...
        private void BindGrid(int page = 0)
        {
            try
            {
                ...
                DataSet user = um.GetSystemUserByUserRole(5);
                if (user != null)
                {
        ...
        protected void grdAdmin_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "SuspendItem")
                {
                    ...
                    SuccessAlert("Consultant successfully suspended");
                }
                if (e.CommandName == "ApproveItem")
                {
                    ...
                    getSavedUsers();
                    SuccessAlert("Consultant successfully activated");
                }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet getsearchdata = lp.getSearchUsers(int.Parse(drpSearchBy.SelectedValue), 5, txtValue.Text);
            if (getsearchdata != null)
            {
                grdAdmin.DataSource = getsearchdata;
                grdAdmin.DataBind();
