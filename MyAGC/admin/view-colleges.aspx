...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <td><code>On mobile,swipe right/left for more info </code></td>
       ...
       <ItemTemplate>
           <asp:LinkButton ID="btnDelete" runat="server" CssClass="btn btn-danger" CommandName="DeleteItem" OnClientClick="return confirm('Are you sure want you want to delete this college?');" CommandArgument='<%#Eval("UserID")%>'>
                          Delete
           </asp:LinkButton>
       </ItemTemplate>
   </asp:TemplateField>
