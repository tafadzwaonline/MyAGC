<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="receipt.aspx.cs" Inherits="MyAGC.admin.receipt" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-lg-8">
                    <div class="card" style="border-radius: 0.25rem; box-shadow: 0 20px 27px 0 rgba(0, 0, 0, 0.05);">
                        <div class="card-body" style="padding: 3rem !important;">
                            ...
                            <div class="mt-5">
                                <div class="d-flex justify-content-end mt-3">
                                    <a href="../admin/paynow-payments" style="width: 100%; height: 50px" class="btn btn-dark btn-lg card-footer-btn justify-content-center text-uppercase-bold-sm hover-lift-light">Back To Payments</a>
