...
{
    public partial class view_agent : System.Web.UI.Page
    {
        ...
        private void getSavedUsers()
        {
            ...
            DataSet getsearchdata = um.GetSystemUserByUserRole(4);
        ...
        private void BindGrid(int page = 0)
        {
            try
            {
                ...
                DataSet user = um.GetSystemUserByUserRole(4);
                if (user != null)
                {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet getsearchdata = lp.getSearchUsers(int.Parse(drpSearchBy.SelectedValue), 4, txtValue.Text);
            if (getsearchdata != null)
            {
                grdAdmin.DataSource = getsearchdata;
                grdAdmin.DataBind();
