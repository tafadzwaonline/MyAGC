<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="my-courier.aspx.cs" Inherits="MyAGC.admin.my_courier" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-wrapper">
     ...
     <asp:TextBox ID="txtParcelDetails" runat="server" class="form-control"></asp:TextBox>
 </div>
                                <div class="col-sm-6 form-group">
    ...
    <asp:TextBox ID="txtweight" runat="server" TextMode="Number" AutoPostBack="true" OnTextChanged="txtweight_TextChanged" class="form-control"></asp:TextBox>
</div>
                                <div class="col-sm-6 form-group">
                                    <label>Amount</label>
    ...
    <asp:TextBox ID="txtRecieverMobile" runat="server" class="form-control"></asp:TextBox>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <asp:TextBox ID="txtReceiverAddress" runat="server" class="form-control"></asp:TextBox>
                                </div>
                                 <div class="col-sm-6 form-group">
