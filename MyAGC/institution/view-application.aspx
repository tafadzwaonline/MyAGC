                    ...
                    <asp:HiddenField ID="txtApplicationID" runat="server" />
                                            ...
                                            <div class="col-sm-6 form-group">
                                              ...
                                              <div class="col-sm-12 reset-button">
                                                 <asp:Button ID="btnApprove" runat="server" Text="Approve" OnClick="btnApprove_Click" class="btn btn-success" />
                                                  <asp:Button ID="btnReject" runat="server" Text="Reject" OnClick="btnReject_Click" class="btn btn-danger" />
