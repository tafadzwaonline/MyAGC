<%@ Page Title="" Language="C#" MasterPageFile="~/InstistutionMaster.Master" AutoEventWireup="true" CodeBehind="institution-information.aspx.cs" Inherits="MyAGC.institution.institution_information" %>
                                    ...
                                    <div class="panel-body">
                                        <form class="col-sm-12" runat="server">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <asp:TextBox ID="txtMissionStatement" runat="server" TextMode="MultiLine" class="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Phone 1</label>
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <asp:DropDownList ID="drpUniversityType" CssClass="form-control dropdown" AutoPostBack="false" runat="server"></asp:DropDownList>
                                            </div> 
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <asp:TextBox ID="txtWebsiteUrl" runat="server"  class="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <label>Country</label>
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <asp:TextBox ID="txtTwitterlink" runat="server"  class="form-control"></asp:TextBox>
                                            </div>

                                            <div class="col-sm-6 form-group">
                                                <label>Facebook Link</label>
                                                <asp:TextBox ID="txtFacebooklink" runat="server"  class="form-control"></asp:TextBox>
                                            </div>
