...
{
    public partial class TotalProgramReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ReportDocument doc = (ReportDocument)Session["ProgramReport"];
                ProgramsReportViewer.ReportSource = doc;
            }
        }
        ...
        private void ViewReport()
        {
            ...
            myReport.Load(Server.MapPath(@"../reports/ProgramsReport.rpt"));
            ...
            myParameterField.ParameterFieldName = "StatusID";
            myDiscreteValue.Value = int.Parse(Session["userid"].ToString());
            ...
            ProgramsReportViewer.ReportSource = myReport;
            ProgramsReportViewer.ParameterFieldInfo = myParameterFields;
            ProgramsReportViewer.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;

            Session["ProgramReport"] = myReport;
        }
    }
}