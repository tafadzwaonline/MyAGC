<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verify-email.aspx.cs" Inherits="MyAGC.verify_email" %>
                ...
                <div class="panel-heading">
                    <div class="view-header">
                        ...
                        <div class="header-title">
                            ...
                            <small><strong>Please check your email to get code.</strong> </small>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    <form id="loginForm" runat="server">
                        <div class="form-group">
                            <label class="control-label" for="code">Code<span style="color: red; position: absolute;">*</span></label>
                        ...
                        <div style="text-align: center;">
                           <%-- <button class="btn btn-primary btn-block">Login</button>--%>
                            <asp:Button ID="BtnValidate" runat="server" Text="Verify Code" class="btn btn-primary btn-block" OnClick="BtnValidate_Click" />
